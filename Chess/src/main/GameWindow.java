...
public class GameWindow extends JPanel{
	...
	public static volatile String bottomText = "Waiting for player...";
	...
	public void bottomText(Graphics g) {
		g.setColor(Color.black);
		g.setFont(new Font("Arial", Font.BOLD, 56));
		g.drawString(bottomText, 40, 690);
	}
	...
	public void paintComponent(Graphics g) {
		...
		if(check == 0) {
			...
			bottomText = "White won!";
		} else if (check == 2) {
			drawBoard(g);
			
			bottomText = "Black won!";
		}
